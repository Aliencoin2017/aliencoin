...
contains(ALIEN_NEED_QT_PLUGINS, 1) {
    DEFINES += ALIEN_NEED_QT_PLUGINS
...
isEmpty(QALIEN_DIR):QALIEN_DIR = $$PWD/src/qt/locale
# automatically build translations, so they can be included in resource file
TSQM.name = lrelease ${QMAKE_FILE_IN}
TSQM.input = TRANSLATIONS
TSQM.output = $$QALIEN_DIR/${QMAKE_FILE_BASE}.qm
