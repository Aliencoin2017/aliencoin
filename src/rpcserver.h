...
extern json_spirit::Value sendalientotoken(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value sendtokentotoken(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value sendtokentoalien(const json_spirit::Array& params, bool fHelp);
